...
GRANT SELECT, INSERT, TRIGGER, UPDATE, DELETE ON TABLE * TO 'dj'@'localhost';
...
START TRANSACTION;
USE `musicdb`;
INSERT INTO `employee` (`id`, `title`, `pay_rate`, `user_id`, `email`, `address_id`) VALUES (1, 'Dj', 100000, 2, 'braidenjamesmiller@gmail.com', 1);
INSERT INTO `employee` (`id`, `title`, `pay_rate`, `user_id`, `email`, `address_id`) VALUES (2, 'Dj', 5, 3, 'test@test.test', 2);
...
START TRANSACTION;
USE `musicdb`;
INSERT INTO `event` (`id`, `name`, `category`, `paid_in_full`, `package_id`, `amount_paid`, `start_date`, `end_date`) VALUES (1, 'Joe and Bob\'s Wedding', 'Wedding', 0, 1, 900, '2019-04-16', '2019-04-16');
INSERT INTO `event` (`id`, `name`, `category`, `paid_in_full`, `package_id`, `amount_paid`, `start_date`, `end_date`) VALUES (2, 'Ston-er Gathering', 'Other', 1, 2, 1500, '2019-04-20', '2019-04-20');
